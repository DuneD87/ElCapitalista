...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/elcapitalista.exe

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/elcapitalista.exe: ${OBJECTFILES}
...
${OBJECTDIR}/PilaCartes.o: PilaCartes.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PilaCartes.o PilaCartes.cpp
